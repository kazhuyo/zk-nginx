...
RUN set -x  \
  ...
  && wget -N https://raw.githubusercontent.com/kazhuyo/zk-nginx/master/geoip/GeoLiteCity.dat.gz \
  && wget -N https://raw.githubusercontent.com/kazhuyo/zk-nginx/master/geoip/GeoIP.dat.gz \
  && gzip -d GeoIP.dat.gz \
